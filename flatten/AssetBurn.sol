...
// File contracts/interfaces/IClonesneverdieAsset.sol
...
// File contracts/airdrop/AssetBurn.sol

pragma solidity ^0.8.10;

contract AssetBurn is Ownable {
	...
	function burn(address[] memory addresses, uint256[] memory ids, uint256[] memory amounts) public onlyOwner {
		for (uint256 i = 0; i < addresses.length; i++) {
			assetNft.burn(addresses[i], ids[i], amounts[i]);
		}
	}
}
